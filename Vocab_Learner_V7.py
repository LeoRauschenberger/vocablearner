...
folderloc = current_directory # you could also add a different directory here e.g. "C:/Users/..."
...
if not os.path.exists(filename):
    print("Output file",name,"does not yet exist in the current folder or couldn't be found. Creating it...")
